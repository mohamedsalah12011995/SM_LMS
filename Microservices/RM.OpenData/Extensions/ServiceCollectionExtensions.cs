...
namespace RM.OpenData.Extensions
{
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddSwaggerGen(this IServiceCollection services)
           ...
           {
               c.SwaggerDoc("v1", new OpenApiInfo { Title = "RM.OpenData", Version = "v1" });
           });
        ...
        public static IServiceCollection RegistrationServices(this IServiceCollection services)
            => services.AddSingleton<IHttpContextAccessor, HttpContextAccessor>()
                       ...
                       .AddScoped<IOpenDataService, OpenDataService>()
                       .AddScoped<IOpenDataTempService, OpenDataTempService>();
    }
}
