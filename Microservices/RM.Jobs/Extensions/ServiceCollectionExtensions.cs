...
namespace RM.Jobs.Extensions
{
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddSwaggerGen(this IServiceCollection services)
           ...
           {
               c.SwaggerDoc("v1", new OpenApiInfo { Title = "RM.Jobs", Version = "v1" });
           });
        ...
        public static IServiceCollection RegistrationServices(this IServiceCollection services)
            => services.AddSingleton<IHttpContextAccessor, HttpContextAccessor>()
                       ...
                       .AddScoped<IJobAdvertisementService, JobAdvertisementService>()
                       .AddScoped<IJobApplicationExamsService, JobApplicationExamsService>()
