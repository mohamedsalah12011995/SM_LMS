...
namespace RM.DynamicForms.UnitOfWorks
{
    public interface IUnitOfWork : IDisposable
    {
        ...
        IBaseRepository<InputsType> InputsType { get; }
        IBaseRepository<FormType> FormType { get; }
        IBaseRepository<FormInputDataSource> FormInputDataSource { get; }
        IBaseRepository<FormsDataSource> FormsDataSource { get; }
        ...
        IBaseRepository<APIDataSource> APIDataSources { get; }
        IBaseRepository<APIDataSourceParamObjectDetail> APIDataSourceParamObjectDetail { get; }
        ...
        IBaseRepository<FormValueViewStatistic> FormValueViewStatistic { get; }
