...
{
    public class QueryExternalTraineeOutputDto
    {
        [JsonIgnore]
        ...
        public static TypeAdapterConfig SelectConfig()
        {
            return new TypeAdapterConfig()
                .NewConfig<Models.ExternalCourseTraniees, QueryExternalTraineeOutputDto>()
                ...
                .Map(dest => dest.StatusAr, src => src.Status == (int)ExamEnums.TraineeStatus.Enrolled ? "متدرب" : "على قائمة الانتظار")
                .Map(dest => dest.StatusEn, src => src.Status == (int)ExamEnums.TraineeStatus.Enrolled ? "Enrolled" : "On waiting list")
