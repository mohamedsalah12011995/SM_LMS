...
namespace RM.Models
{
    [Table("InternalCourseExams", Schema = "ExamTraining")]
    public class InternalCourseExams
    {
        ...
        [ForeignKey("InternalCourseTrainee")]
        public int? InternalCourseTraineeId { get; set; }
        ...
        public virtual InternalCourseTrainees InternalCourseTrainee { get; set; }
