...
namespace RM.Core.Integrations
{
    ...
    {
        public static async Task<ApplicationOperation.ResponseOutput> SaveInteractionStatistics(string StatisticsServiceUrl, string Token, int? ReferenceId, int? EntityId, int? ItemId,
            Enums.InteractionStatisticsType StatisticsType, string ItemUrl = null)
        {
            ...
            return JsonSerializer.Deserialize<ApplicationOperation.ResponseOutput>(response.Content.ReadAsStringAsync().Result);
        }
    }
}
